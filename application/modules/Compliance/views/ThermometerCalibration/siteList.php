                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 text-black"><i class="fa-solid fa-thermometer-half"></i> Thermometer Calibration Sites</h4>

                                <div class="page-title-right">
                                    <div class="d-flex justify-content-sm-end gap-2">
                                        <a href="<?php echo base_url('Compliance/ThermometerCalibration/Home') ?>" class="btn btn-secondary">
                                            <i class="ri-arrow-go-back-line"></i> Back to Dashboard
                                        </a>
                                        <a href="<?php echo base_url('Compliance/ThermometerCalibration/Site/add') ?>" class="btn btn-primary">
                                ...
                                <div class="table-responsive table-card mb-1">
                                    <table class="table align-middle table-nowrap" id="siteListDatatable">
                                        ...
                                        <tbody class="list form-check-all">
                                                        ...
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a href="<?php echo base_url('Compliance/ThermometerCalibration/Site/edit/'.$site['id']); ?>" 
                                            ...
                                            <?php } else { ?>
                                                <tr>
                                                    <td colspan="3" class="text-center">No sites found. <a href="<?php echo base_url('Compliance/ThermometerCalibration/Site/add'); ?>">Add your first site</a>.</td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
...
$(document).on("click", ".remove-item-btn", function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('Compliance/ThermometerCalibration/Site/delete'); ?>",
                data: { id: id },
...
$(document).on("change", ".toggle-demo", function() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('Compliance/ThermometerCalibration/Site/change_status'); ?>",
