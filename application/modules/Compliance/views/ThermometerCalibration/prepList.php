                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 text-black"><i class="fa-solid fa-thermometer-half"></i> Thermometer Calibration Prep Areas</h4>
...
$(document).ready(function() {
    ...
    $("#sortable").sortable({
        update: function(event, ui) {
            ...
            $.ajax({
                url: "<?php echo base_url('Compliance/ThermometerCalibration/Prep/updateSortOrder'); ?>",
                type: "POST",
...
$(document).on("click", ".remove-item-btn", function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('Compliance/ThermometerCalibration/Prep/delete'); ?>",
                data: { id: id },
                success: function(response) {
                    if(response == 'success') {
...
$(document).on("change", ".toggle-demo", function() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('Compliance/ThermometerCalibration/Prep/change_status'); ?>",
