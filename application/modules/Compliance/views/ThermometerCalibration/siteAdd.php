                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php if($form_type == 'add'){ ?>    
                                <form action="<?php echo base_url('Compliance/ThermometerCalibration/Site/add'); ?>" method="POST">
                            <?php } else if($form_type == 'edit'){ ?>
                                <form action="<?php echo base_url('Compliance/ThermometerCalibration/Site/edit/'.(isset($site_detail[0]['id']) ? $site_detail[0]['id'] : '')); ?>" method="POST">     
                            <?php } ?>
                            <div id="customerList">
                                    ...
                                    <div class="col-sm-auto">
                                        <div>
                                            <h4 class="card-title mb-0 text-uppercase fw-bold text-black">
                                                <i class="fa-solid fa-thermometer-half"></i> <?php echo ucfirst($form_type); ?> Thermometer Calibration Site
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                        <div class="d-flex justify-content-sm-end gap-2">
                                            ...
                                            <?php } ?>
                                            <a href="<?php echo base_url('Compliance/ThermometerCalibration/Site'); ?>" class="btn bg-orange waves-effect btn-label waves-light">
