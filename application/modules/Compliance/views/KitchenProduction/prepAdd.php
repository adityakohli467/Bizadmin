                                    ...
                                    <div class="col-sm-auto">
                                        <div>
                                            <h4 class="card-title mb-0 text-uppercase fw-bold text-black">
                                                <i class="fa-solid fa-utensils"></i> <?php echo ucfirst($form_type); ?> Kitchen Production Prep Area
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                        <div class="d-flex justify-content-sm-end gap-2">
                                            ...
                                            <?php } ?>
                                            <a href="<?php echo base_url('Compliance/KitchenProduction/Prep'); ?>" class="btn bg-orange waves-effect btn-label waves-light">
