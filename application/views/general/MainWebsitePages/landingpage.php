...
<div class="font-inter text-gray-800 bg-white overflow-hidden">
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="lg:w-1/2 w-full relative">
                    <img src="<?php echo $landing_assets; ?>hero-product.png" alt="BizAdmin dashboard and Bizzy AI on mobile" class="relative z-10 w-full h-auto object-contain origin-right lg:scale-[1.05] lg:translate-x-2 xl:translate-x-4" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                foreach ($features as $f): ?>
                    <div class="bg-white border border-slate-100 rounded-2xl px-4 py-6 text-center hover:shadow-md transition">
                        <div class="text-3xl mb-4 <?php echo $f[1]; ?> flex items-center justify-center h-9">
                            <?php if ($f[2] === 'Google Partner'): ?>
    ...
    <!-- ============================================================
         9. PRICING PLANS (3 tiers)
         ============================================================ -->
    <section id="pricing" class="py-14 md:py-20 bg-white scroll-mt-24">
        <div class="container mx-auto px-4 lg:px-8">
